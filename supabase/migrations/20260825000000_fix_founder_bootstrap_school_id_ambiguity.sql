-- Fix school_id ambiguity in public.dreem_bootstrap_school function
-- Qualify all school_id references with proper table aliases
...
begin
  ...
  update public.dreem_school_memberships m
  ...
  on conflict on constraint dreem_school_brands_pkey
  do update
