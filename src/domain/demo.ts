...
export const demoBrand: SchoolBrand = {
  ...
  shortName: "DDS",
  motto: "Knowledge Â· Character Â· Service",
  ...
  lessonPlans: [
    {
      ...
      objectives: "Represent and compare equivalent fractions.",
      learningActivity: "Paired fraction-strip investigation and guided practice.",
      evidence: "Exit ticket and marked practice set.",
      followUp: "Reteach comparing unlike denominators for the support group.",
      status: "reviewed",
      createdBy: "t1",
...
export const demoPulse: PulseAction[] = [
  {
    id: "p1",
    category: "finance",
    title: "Cash closure variance Â· 12,500 FCFA",
    explanation:
      "Expected 487,500 Â· physically counted 475,000 Â· explanation attached",
    owner: "Accountant",
    dueLabel: "Today Â· 11:00",
    severity: "warning",
    evidenceCount: 24,
  },
  {
