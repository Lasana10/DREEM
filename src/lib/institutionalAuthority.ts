...
export const authorityScopeOptions:{value:AuthorityScope;label:string;description:string}[]=[
  ...
  {value:"academics_delivery",label:"Academic delivery",description:"Teach, assess, give feedback and support assigned learners."},
  {value:"academics_approval",label:"Academic approval",description:"Curriculum oversight, moderation, review and publication control."},
  {value:"admissions_intake",label:"Admissions intake",description:"Receive applications, documents and enrolment preparation."},
  {value:"admissions_decision",label:"Admissions decision",description:"Offer, reject, approve and complete institutional admission."},
  ...
  {value:"transport_management",label:"Transport management",description:"Routes, fleet, assignments, dispatch and transport exceptions."},
  {value:"transport_operation",label:"Transport operation",description:"Operate an assigned journey and record trip evidence."},
  ...
  {value:"communications_publish",label:"Communications publishing",description:"Create official notices within delegated audiences and categories."},
...
export const positionPresets:{title:string;category:PositionCategory;scopes:AuthorityScope[]}[]=[
  ...
  {title:"Dean / Academic Head",category:"academic",scopes:["academics_approval","admissions_decision","communications_publish"]},
  {title:"Teacher",category:"academic",scopes:["academics_delivery"]},
  {title:"Registrar / Admissions Lead",category:"operations",scopes:["admissions_intake","admissions_decision","communications_publish"]},
  ...
  {title:"Transport Manager",category:"operations",scopes:["transport_management","communications_publish"]},
