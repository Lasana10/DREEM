...
const nav = [
  ...
  { id: "credentials" as const, label: "ID card studio", icon: IdCard },
...
export default function Shell({ brand,viewer,view,onView,signalCount,onFeedback,children }: {
  brand: SchoolBrand; viewer: { name: string; email: string; role: Role }; view: ViewKey; onView: (view: ViewKey) => void; signalCount: number; onFeedback: () => void; children: ReactNode;
}) {
